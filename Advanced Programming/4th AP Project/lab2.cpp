...
public:
    ...
    {
        this -> real.a = r.a;
        this -> real.b = Rational::set_b(r.b);
    };
    void set_img (Rational i)
    {
        this -> img.a = i.a;
        this -> img.b = Rational::set_b(i.b);
    };
    void set_complex (Rational r, Rational i)
    {
        result.real = set_real(Rational r);
        result.img = set_img(Rational i);
    };
